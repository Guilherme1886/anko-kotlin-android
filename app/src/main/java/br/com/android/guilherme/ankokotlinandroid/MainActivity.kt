...
class MainActivity : AppCompatActivity(),
    ...
    val reactPermissions = ReactivePermissions(this, REQUEST_CODE)
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.nav_email) {
            email(
                    "guilherme.jose95@hotmail.com, gui@gmail.com",
                    "Dúvida Android",
                    "Olá \n\n"
            )
        } else if (id == R.id.nav_compartilhar) {
            share("www.google.com", "Google")
    ...
    private fun makeCallPhone() {
        ...
        reactPermissions.observeResultPermissions().subscribe {
            event ->
            if (event.second) {
                makeCall("981369848")
            }
        ...
        reactPermissions.evaluate(permissions)
    ...
    override fun onRequestPermissionsResult(requestCode: Int,
        ...
        if (requestCode == REQUEST_CODE) {
            reactPermissions.receive(permissions, grantResults)
        }
    }
}
